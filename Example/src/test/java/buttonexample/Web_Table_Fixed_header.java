...
public static WebDriver driver=null;
	...
	static WebElement getfixedtable;
...
WebDriverManager.chromedriver().setup();
		...
		PageFactory.initElements(driver, Web_Table_Fixed_header.class);
	       ...
	       Thread.sleep(2000);
	       List<WebElement> rowsList = getfixedtable.findElements(By.tagName("tr"));
	       Thread.sleep(2000);
