...
public class LoginPage_original_new_current extends TestBase_original_new_current{
	...
	//WebDriver driver;
	 ...
	 @FindBy(xpath="//input[@name='email']")
		...
		public LoginPage_original_new_current(WebDriver driver) {
			LoginPage_original_new_current.driver = driver;
		...
		public void Loginpageforlandlord(String username3, String password3) throws Exception {
