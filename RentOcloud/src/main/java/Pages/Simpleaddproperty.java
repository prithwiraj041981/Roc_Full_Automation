...
public class Simpleaddproperty extends TestBase {
 ...
 public static final long TIMEOUT = 30;
	 ...
	 WebElement btn_create_property;
		  ...
		  @FindBy(how=How.XPATH, using="/html/body/div[4]/div/div[2]/div/div[2]/div/div/div[1]/div/p[2]")
	 ...
	 public Simpleaddproperty(WebDriver driver) {
		 Simpleaddproperty.driver = driver;
			  PageFactory.initElements(driver, this);
		  
		  }
	 
	 public void addsmpropertyforlandlord() {
		 property.click();
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 addproperty.click();
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 propertylocation.sendKeys("mm");
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 ...
		 //WebElement select = driver.findElement(By.className("ant-space ant-space-horizontal ant-space-align-basline"));
	       ...
	       options.get(0).click();
			/*
			 * if(frame_duplicate.getText().
			 * equalsIgnoreCase("Do you want to duplicate property?")) {
			 * 
			 * duplicate.click();
