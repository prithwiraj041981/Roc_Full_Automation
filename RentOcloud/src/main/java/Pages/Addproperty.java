...
public class Addproperty extends TestBase {
 ...
 WebElement btn_create_property;
		  ...
		  WebElement  frame_duplicate;
			 ...
			 @FindBy(how=How.XPATH, using="/html/body/div[4]/div/div[2]/div/div[2]/div/div/div/div/div/div/div/table/thead")
	 ...
	 public void addpropertyforlandlord() {
		 property.click();
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 addproperty.click();
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 propertylocation.sendKeys("M M2 Apartments, Pickford Street");
		 driver.manage().timeouts().implicitlyWait(TIMEOUT, TimeUnit.SECONDS);
		 ...
		 //WebElement select = driver.findElement(By.className("ant-space ant-space-horizontal ant-space-align-basline"));
	       ...
	       if(loweraddress.getText().equalsIgnoreCase("Select Your Address")) {
				 System.out.println("prithvi after") ;
