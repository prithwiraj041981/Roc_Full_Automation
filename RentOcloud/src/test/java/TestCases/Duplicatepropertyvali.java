...
import Pages.Duplicateproperty;
...
public class Duplicatepropertyvali extends TestBase{
	...
	public void launchBrowser() throws IOException {
    	...
    	tbase.Base_url();
    	   ...
    	   public void Validateproperty() throws IOException
    	   {
    		   ...
    		   Duplicateproperty dupaddpro=new Duplicateproperty(driver);
    		   dupaddpro.addduppropertyforlandlord();
